<%@ Page Title="" Language="C#" MasterPageFile="~/View/Layout/Site1.Master" AutoEventWireup="true" CodeBehind="Adduser.aspx.cs" Inherits="HRMS.View.Modules.Adduser" %>
            ...
            <div class="card employee-form-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4 employee-form-header">
                        <asp:Label runat="server" ID="lbluser" CssClass="card-title employee-form-title">Add New Employee</asp:Label>
