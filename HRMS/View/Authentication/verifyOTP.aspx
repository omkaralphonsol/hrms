                                    ...
                                    <div class="row">
                                        <div class="col-7 mx-auto">
                                            <div class="text-primary p-4">
                                                <h4 class="text-primary">HRMS Login</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="mt-3 d-grid">
    <asp:Button ID="btn_verifyOtp" runat="server" Text="Verify OTP" CssClass="btn btn-primary waves-effect waves-light" OnClick="btn_verifyOtp_Click" />
</div>  
                                    </div>
                                    <%--<div class="mt-3 d-grid">
                                        <asp:Button ID="btn_sendmail" runat="server" Text="Send OTP" CssClass="btn btn-primary waves-effect waves-light" CommandArgument="Send OTP" OnClick="btn_send_Click" />
                                    </div>--%>

<%--                                    <asp:Button ID="btn_verifyOtp" runat="server" Text="Verify OTP" CssClass="btn btn-success" OnClick="btn_verifyOtp_Click" />--%>
